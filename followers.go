...
func (f *InstagramFollowers) User(userID int64, options ...string) (output FollowerAndFollowingResponse, err error) {
	if len(options) > 1 {
...
func (f *InstagramFollowers) Current(maxID ...string) (FollowerAndFollowingResponse, error) {
